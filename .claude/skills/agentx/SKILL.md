...
- Tabs are alternate views of ONE state: dataset, selection, and serving assumptions
  flow from the Explorer tab everywhere (shared selection store; the two conversation
